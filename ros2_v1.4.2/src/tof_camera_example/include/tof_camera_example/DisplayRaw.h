...
static constexpr uint8_t RAW_MAX = (krm::IMG_RAW4 - krm::IMG_RAW1) + 1U;
...
public:
	...
	/*------------------------------------------------------------------*/
	bool setFormat(const krm::ImageFormats& img_fmts);
	/*------------------------------------------------------------------*/
...
private:
	...
	std::array<krm::ImageFormat, RAW_MAX>	fmts_;		/* original RAW format */
