...
/*-----------------------------------------------------------------*/
static const uint8_t IMG_PCD = krm::IMG_KINDS;
...
public:
	...
	/*------------------------------------------------------------------*/
	void convScreenPcd(const std::vector<krm::Point3d> *world_pos, bool need_update, std::vector<krm::Point3d>& out_pnt);
	/*------------------------------------------------------------------*/
	/// @brief	convert grid line to draw image position (camera view)
	///	@param	[in]	need_update	is required of conversion calculation
	///	@param	[out]	out_pnt		output Grid points
	/*------------------------------------------------------------------*/
	void convScreenGridCamera(bool need_update, std::vector<std::pair<krm::Point3d, krm::Point3d>>& out_pnt);
	/*------------------------------------------------------------------*/
	/// @brief	convert grid line to draw image position (world view)
	///	@param	[in]	need_update	is required of conversion calculation
	///	@param	[out]	out_pnt		output Grid point
	/*------------------------------------------------------------------*/
	void convScreenGridWorld(bool need_update, std::vector<std::pair<krm::Point3d, krm::Point3d>>& out_pnt);
...
private:
	...
	krm::PcdData				pcd_org_;		/* point cloud data */
	std::vector<krm::Point3d>	pcd_draw_;		/* point cloud data */
	std::vector<krm::Point3d>	pcd_screen_;	/* point cloud data */
	std::vector<krm::Point3d>	pcd_filtered_;	/* point cloud data */
	...
	std::vector<std::pair<krm::Point3d, krm::Point3d>>	grid_screen_;	/* grid data */
	...
	/*------------------------------------------------------------------*/
	void interleaveImage(const std::vector<krm::Point3d>& src);
	...
	/*------------------------------------------------------------------*/
	krm::Point3d convScreenPnt(krm::Point3d world_pos);
